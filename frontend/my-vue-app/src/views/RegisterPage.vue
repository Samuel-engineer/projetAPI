        ...
        <div class="register-form-container">
            <form id="registerForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <p>have an account? <router-link @click="scrollToTop()" to="/">login</router-link>
                    </p>
                </div>
            </form>
        </div>
...
export default {
    ...
    methods: {
        ...
        async register() {
            try {
                await api.register({ email: this.registerObj.email, password: this.registerObj.pass });
            } catch (error) {
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                this.register();
                this.$router.push('/');  // Rediriger après connexion réussie
